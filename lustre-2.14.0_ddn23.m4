...
(.+
 ...
 +snapshot_time: +.+
  ...
  migrate: +\{ samples: +([[:digit:]]+), unit: usecs, min: *([[:digit:]]+), max: *([[:digit:]]+), sum: *([[:digit:]]+), sumsq: *([[:digit:]]+) }</pattern>
						...
						JOBSTAT_FIELD_META_OPERATIONS(6, 12, mknod, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 17, link, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 22, unlink, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 27, mkdir, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 32, rmdir, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 37, rename, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 42, getattr, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 47, setattr, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 52, getxattr, number, mdt, 1)
						JOBSTAT_FIELD_META_OPERATIONS(6, 57, setxattr, number, mdt, 1)
						...
						JOBSTAT_FIELD_META_OPERATIONS(6, 97, migrate, number, mdt, 1)
					</item>
				</entry>
			</entry>
		</entry>
 ...
 +snapshot_time: +.+
  ...
  prealloc: +\{ samples: +([[:digit:]]+), unit: usecs, min: *([[:digit:]]+), max: *([[:digit:]]+), sum: *([[:digit:]]+), sumsq: *([[:digit:]]+) }</pattern>
						...
						JOBSTAT_FIELD_META_OPERATIONS(6, 70, prealloc, number, ost, 1)
					</item>
				</entry>
			</entry>
		</entry>
