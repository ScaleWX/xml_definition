...
<definition>
	...
	<entry>
		...
		VD_QDEPTH(2, `', `Virtual Disk Qdepth:', `Virtual Disk Qdepth (abs):', gauge, 1)
		VD_QDEPTH(2, _abs, `Virtual Disk Qdepth (abs):', `  Idx  Unmap Count Unmap Blocks| Unmap Count Unmap Blocks|', derive, 1)
		UNMAP(2, vd, 1, `')
	</entry>
	<entry>
		<subpath>
